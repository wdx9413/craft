...
export class KnowledgeWorkbenchKernel {
    ...
    view(args = {}) {
        ...
        const launches = this.store.list("work_launch", 10_000, (launch) => launch.knowledge_binding !== undefined).map((launch) => ({
            ...
            knowledge_binding: pick(launch.knowledge_binding, ["bundle_id", "bundle_version", "bundle_digest", "context_digest", "scope", "claim_refs"]),
        }));
        return {
            summary: {
...
//# sourceMappingURL=knowledge-workbench.js.map
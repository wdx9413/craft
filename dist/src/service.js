...
export class CraftService extends ServiceFoundation {
    ...
    intentCompile(args) { return this.intentCompiler.compile(args); }
    intentGet(args) { return this.intentCompiler.get(args); }
    acceptanceCompile(args) { return this.intentCompiler.acceptanceCompile(args); }
    acceptanceContractGet(args) { return this.intentCompiler.acceptanceGet(args); }
    taskCheckpoint(args) {
        const taskId = text(args.task_id, "task_id");
    ...
    async mcpRegistrySync(args) { return this.mcpRegistry.sync(args); }
    async a2aTransportDispatch(args) { return this.a2aTransport.dispatch(args); }
    async a2aTransportTaskGet(args) { return this.a2aTransport.taskGet(args); }
    async a2aTransportTaskCancel(args) { return this.a2aTransport.taskCancel(args); }
    ...
    workSessionBindDispatch(args) { return this.workSessions.bindDispatch(args); }
    ...
    longTaskTick(args = {}) { return this.longTaskWorker.tick(args); }
    trialGet(args) {
        const trialId = text(args.trial_id, "trial_id");

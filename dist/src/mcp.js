...
export const TOOLS = [
    ...
    tool("craft_execution_fabric_get", "Read the joined Fabric, Work Loop, Host Manifest, and immutable advances.", ["fabric_id"], true),
...
export class McpServer {
    ...
    constructor(service, mode = "full") {
        ...
        this.handlers = {
            ...
            craft_execution_fabric_prepare: service.executionFabricPrepare.bind(service), craft_execution_fabric_advance: service.executionFabricAdvance.bind(service), craft_execution_fabric_consume: service.executionFabricConsume.bind(service), craft_execution_fabric_get: service.executionFabricGet.bind(service),
            ...
            craft_eval_campaign_create: (a) => service.evalCampaignCreate(a), craft_eval_campaign_bind: (a) => service.evalCampaignBind(a), craft_eval_campaign_advance: (a) => service.evalCampaignAdvance(a), craft_eval_campaign_get: (a) => service.evalCampaignGet(a),

...
> Current release: v0.11.42. Recent additions include reproducible Evidence Wiki Context Bundles, fail-closed knowledge-bound Work Launches, and a visible Goal-Material-Decision-Result guided-work flow in Workbench.

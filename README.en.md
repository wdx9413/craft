...
> Current release: v0.11.36. Recent additions include reproducible Evidence Wiki Context Bundles, fail-closed knowledge-bound Work Launches, and human-imported cross-host Wiki candidate packages with complete evaluation lineage.

...
assert.deepEqual(server.args, ["dist/plugin/craft-mcp.cjs", "--product", "full"]);
...
try {
  ...
  const request = [
    { jsonrpc: "2.0", id: 1, method: "initialize", params: { protocolVersion: MCP_PREFERRED_PROTOCOL_VERSION } },

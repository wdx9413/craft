...
test("v0.11.59 distinguishes portable, guarded, isolated and external autonomy", async () => {
...
test("Full MCP starts one comparable Agent Eval attempt and exposes every v0.11.59 action", async () => {
  const f = await fixture();
  try {

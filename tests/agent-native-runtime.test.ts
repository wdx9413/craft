...
test("v0.11.60 distinguishes portable, guarded, isolated and external autonomy", async () => {
...
test("Full MCP starts one comparable Agent Eval attempt and exposes every v0.11.60 action", async () => {
  const f = await fixture();
  try {

...
TOOLS = [
    ...
    {"name": "craft_workflow_save", "description": "Save a versioned, structured workflow candidate derived from actual work and user feedback.", "inputSchema": schema({"name": {"type": "string"}, "goal": {"type": "string"}, "steps": {"type": "array", "minItems": 1, "items": {"type": "object"}}, "scope": {"type": "string", "enum": ["task", "project", "user"], "default": "user"}, "status": {"type": "string", "enum": ["candidate", "tested", "reusable", "deprecated"], "default": "candidate"}, "source_task_id": {"type": "string"}, "workflow_id": {"type": "string"}, "inputs": {"type": "array", "items": {"type": "object"}}, "success_criteria": {"type": "array", "items": {"type": "string"}}}, ["name", "goal", "steps"])},

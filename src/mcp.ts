...
export class McpServer {
  ...
  constructor(service: CraftService, mode: string = "full") {
    ...
    this.handlers = {
      ...
      craft_knowledge_memory_install_builtins: service.knowledgeMemoryInstallBuiltins.bind(service), craft_knowledge_source_register: service.knowledgeSourceRegister.bind(service),

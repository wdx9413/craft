...
declare module "../craft-service.ts" {
  interface CraftService {
    ...
    graphCompile(args: JsonObject): JsonObject;
    contextWorkingSetResolve(args: JsonObject): JsonObject | Promise<JsonObject>;
    contextWorkingSetGet(args: JsonObject): JsonObject;
    runtimeAttemptPrepare(args: JsonObject): JsonObject;
    runtimeAttemptDispatch(args: JsonObject): JsonObject;
    runtimeAttemptReceiptPending(args: JsonObject): JsonObject;
    runtimeAttemptRecordReceipt(args: JsonObject): JsonObject;
    runtimeAttemptObserve(args: JsonObject): JsonObject;
    runtimeAttemptResolveEffect(args: JsonObject): JsonObject;
    runtimeAttemptRecover(args: JsonObject): JsonObject;
    runtimeAttemptCancel(args: JsonObject): JsonObject;
    runtimeAttemptGet(args: JsonObject): JsonObject;
    capabilityIntakeDiscover(args: JsonObject): JsonObject;
    capabilityIntakeScan(args: JsonObject): JsonObject;
    capabilityIntakeConformance(args: JsonObject): JsonObject;
    capabilityIntakeApprove(args: JsonObject): JsonObject;
    capabilityIntakeActivate(args: JsonObject): JsonObject;
    capabilityIntakeRevoke(args: JsonObject): JsonObject;
    capabilityIntakeUpgradePlan(args: JsonObject): JsonObject;
    capabilityIntakeGet(args: JsonObject): JsonObject;
    capabilityIntakeList(args?: JsonObject): JsonObject;
    workbenchCommandExecute(args: JsonObject): JsonObject | Promise<JsonObject>;
    workbenchCommandGet(args: JsonObject): JsonObject;
    workbenchCommandList(args?: JsonObject): JsonObject;
...
export function installKernelDelegateMethods(serviceClass: typeof CraftService): void {
  ...
  serviceClass.prototype.graphCompile = function (args) { return this.graphCompiler.compile(args); };
  serviceClass.prototype.contextWorkingSetResolve = function (args) { return this.contextWorkingSets.resolve(args); };
  serviceClass.prototype.contextWorkingSetGet = function (args) { return this.contextWorkingSets.get(args); };
  serviceClass.prototype.runtimeAttemptPrepare = function (args) { return this.runtimeAttempts.prepare(args); };
  serviceClass.prototype.runtimeAttemptDispatch = function (args) { return this.runtimeAttempts.dispatch(args); };
  serviceClass.prototype.runtimeAttemptReceiptPending = function (args) { return this.runtimeAttempts.receiptPending(args); };
  serviceClass.prototype.runtimeAttemptRecordReceipt = function (args) { return this.runtimeAttempts.recordReceipt(args); };
  serviceClass.prototype.runtimeAttemptObserve = function (args) { return this.runtimeAttempts.observe(args); };
  serviceClass.prototype.runtimeAttemptResolveEffect = function (args) { return this.runtimeAttempts.resolveEffect(args); };
  serviceClass.prototype.runtimeAttemptRecover = function (args) { return this.runtimeAttempts.recover(args); };
  serviceClass.prototype.runtimeAttemptCancel = function (args) { return this.runtimeAttempts.cancel(args); };
  serviceClass.prototype.runtimeAttemptGet = function (args) { return this.runtimeAttempts.get(args); };
  serviceClass.prototype.capabilityIntakeDiscover = function (args) { return this.capabilityIntake.discover(args); };
  serviceClass.prototype.capabilityIntakeScan = function (args) { return this.capabilityIntake.scan(args); };
  serviceClass.prototype.capabilityIntakeConformance = function (args) { return this.capabilityIntake.conformance(args); };
  serviceClass.prototype.capabilityIntakeApprove = function (args) { return this.capabilityIntake.approve(args); };
  serviceClass.prototype.capabilityIntakeActivate = function (args) { return this.capabilityIntake.activate(args); };
  serviceClass.prototype.capabilityIntakeRevoke = function (args) { return this.capabilityIntake.revoke(args); };
  serviceClass.prototype.capabilityIntakeUpgradePlan = function (args) { return this.capabilityIntake.upgradePlan(args); };
  serviceClass.prototype.capabilityIntakeGet = function (args) { return this.capabilityIntake.get(args); };
  serviceClass.prototype.capabilityIntakeList = function (args = {}) { return this.capabilityIntake.list(args); };
  serviceClass.prototype.workbenchCommandExecute = function (args) { return this.workbenchCommands.execute(args); };
  serviceClass.prototype.workbenchCommandGet = function (args) { return this.workbenchCommands.get(args); };
  serviceClass.prototype.workbenchCommandList = function (args = {}) { return this.workbenchCommands.list(args); };

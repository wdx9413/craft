...
export class CraftService extends ServiceFoundation {
  ...
  info(): JsonObject {
    const kinds = ["source", "capability", "task", "checkpoint", "feedback", "artifact",
      ...
      "trajectory_script_proposal", "verified_script_run", "knowledge_claim", "wiki_page", "knowledge_relation", "wiki_context_bundle", "wiki_skill_candidate", "knowledge_evaluation_case", "knowledge_evaluation_run", "wiki_candidate_evaluation_attestation", "wiki_candidate_publication_authorization"];
  ...
  private wikiCandidateClaimsCurrent(candidate: JsonObject): void {
    const refs = array(candidate.claim_refs, "Wiki candidate claim_refs") as JsonObject[];
  ...
  private wikiCandidateEvaluationProof(candidate: JsonObject, candidateVersion: number, args: JsonObject): JsonObject {
  ...
  wikiSkillCandidateEvaluationAttest(args: JsonObject): JsonObject {
    ...
    const proof = this.wikiCandidateEvaluationProof(candidate, Number(candidate.version), args); const identity = { ...proof };

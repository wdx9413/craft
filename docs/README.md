...
- [Runtime Truth（v0.12.8）](technical/modules/runtime-truth.zh-CN.md)：统一 Trace、Tool Call、SSE、OTLP、压缩和结构化工作笔记。
- [Runtime Boundaries（v0.12.8）](technical/modules/v0128-runtime-boundaries.zh-CN.md)：OS 安全计划、MCP Registry、A2A Transport 与组织同步。
...
文档区分“已实现接口/机制”“真实链路已验收”和“目标/待实现”。v0.12.8 的本地接口与测试已实现；真实平台 OS 沙箱、Secret Broker、OTLP 部署、远程 A2A 和多人同步仍须由对应 Adapter 提供独立证明。有代码、100% 单元覆盖率、真实平台安全与业务质量是不同证据。

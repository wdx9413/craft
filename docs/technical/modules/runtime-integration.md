...
关联：[Agent IR](agent-ir.md) · [Capability Kit](capability-kit.md) · [Capability Connector](capability-connectors.md) · [Workflow/Signoff](workflow-signoff.md) · [Codex Driver](codex-host-driver.md) · [Claude Driver](claude-host-driver.md)

# Current Capability Matrix (v0.12.12)
...
| Durable checkpoint tick | implemented locally | expiry/wake processing is bounded; v0.12.12 adds persistent local runtime service state, while OS scheduler and notification delivery remain adapters |

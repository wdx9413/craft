# Current Capability Matrix (v0.12.10)

| Area | State | Boundary |
|---|---|---|
| Project Brain / Work Session | implemented and tested locally | content-light projection; Markdown remains source of truth |
...
| Trace / Workbench projection | implemented locally | replay is a revalidation plan, not an executor |
...
| Durable checkpoint tick | implemented locally | expiry/wake processing is bounded and requires a fresh Host; no system scheduler or notification service is bundled |
